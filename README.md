...
- **🌐 Website Generator**: Sistema automático de criação de sites com IA (🆕)
...
- **Website Generator AI**: Geração automática de sites com OpenAI + templates (🆕)
...
- **Conta no Render** (para deploy - https://render.com)

### 🚀 Setup Rápido (3 passos)

#### 1. Instalação Automática

**Opção A - Node.js (Linux/Mac/Windows):**
```bash
npm run setup
```
...
# Configure no Render: https://dashboard.render.com
```
...
- 🚀 **[QUICKSTART.md](docs/QUICKSTART.md)** - Comece aqui! (15 minutos)
- 🔧 **[SETUP-GITHUB.md](docs/SETUP-GITHUB.md)** - Configuração completa do GitHub
- 🌐 **[SETUP-RENDER.md](docs/SETUP-RENDER.md)** - Deploy e configuração do Render  
- ✅ **[SETUP-COMPLETE.md](docs/SETUP-COMPLETE.md)** - Resumo e validação final
- 🤖 **[WEBSITE-GENERATOR.md](docs/WEBSITE-GENERATOR.md)** - Sistema de criação automática de sites com IA 🆕
...
- [WEBSITE-GENERATOR.md](docs/WEBSITE-GENERATOR.md) - 🤖 Sistema de geração automática de sites com IA 🆕

## 🌐 Sistema de Geração de Sites (Novo!)

O projeto agora inclui um sistema completo de criação automática de websites usando IA:

### ✨ Características
- **Wizard em 3 passos** - Formulário simples e rápido
- **8 templates profissionais** - Clínica, Escritório, Restaurante, etc
- **IA para conteúdo** - OpenAI gera headlines, serviços e FAQ
- **Preview em tempo real** - Cliente vê antes de publicar
- **Sites estáticos** - Performance 100/100 Lighthouse
- **Deploy automático** - Subdomínios em `avila.inc`

### 🚀 Acesso Rápido
- **Criar site**: http://localhost:5000/criar-site
- **Ver status**: http://localhost:5000/meu-site/{id}
- **API**: http://localhost:7001/api/public/website-requests

📖 **Documentação completa**: [WEBSITE-GENERATOR.md](docs/WEBSITE-GENERATOR.md)
